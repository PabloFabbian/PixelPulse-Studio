        ...
        <div className="bg-gradient-to-tr from-indigo-900 via-[#161F31] to-[#111827]" id="Services">
            <div className="container mx-auto py-16 px-6">
                <div className="flex flex-col md:flex-row lg:flex-row lg:space-x-16">
                    <div className="md:w-full lg:w-1/2 mb-6 mr-6 lg:mb-0 flex flex-col justify-center">
